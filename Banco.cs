    ...
    class Banco
    {
        ...
        public Banco()
        {
            try
            {
                ...
                // "User ID=sa;Password=localhost\\sqlexpress;" +
                // "Server=localhost\\SQLEXPRESS;" +
                // "Database=vendas;" +
                // "Trusted_Connection=False;");
                SqlConnectionStringBuilder builder = new SqlConnectionStringBuilder("Server=localhost\\SQLEXPRESS;Database=vendas;Trusted_Connection=True;");
